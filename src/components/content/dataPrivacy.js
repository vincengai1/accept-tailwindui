...
import { dataPrivacyContentSection } from './text/dataPrivacyText';
import { dataPrivacyAudioSection } from './text/dataPrivacyText';
...
export default function DataPrivacy({data}) {
  ...
  useEffect( () => {
    ...
    if (!targetLanguage) {
      ...
      setAudioContent(dataPrivacyAudioSection);
      fetchAudio(dataPrivacyAudioSection);
    }
