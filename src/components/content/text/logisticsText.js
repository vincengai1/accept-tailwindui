...
<img translate="no"       src="http://localhost:8080/img/graphic2.png" alt="graphic2" style="width: 100%; margin-bottom: 1rem; cursor: pointer;" />
...
<img translate="no"       src="http://localhost:8080/img/graphic3.png" alt="graphic3" style="width: 100%; margin-bottom: 1rem; cursor: pointer;" />
...
<div style="display: flex; align-items: center;">
  <img translate="no"       src="http://localhost:8080/img/Wellness.png" alt="Wellness" style="margin-right:10px;" />
  <p className="pageText">
    <b>Wellness checks</b>
  </p>
</div>
...
<div style="display: flex; align-items: center;">
  <img translate="no"       src="http://localhost:8080/img/Lab.png" alt="lab" style="margin-right:10px;" />
  <p className="pageText">
...
<div style="display: flex; align-items: center;">
  <img translate="no"       src="http://localhost:8080/img/XRay.png" alt="xray" style="margin-right:10px;" />
  <p className="pageText">
...
<div style="display: flex; flex-direction: column">
  <img translate="no"       src="http://localhost:8080/img/Group 204.png" alt="group204"/>
  <img translate="no"       src="http://localhost:8080/img/Group205.png" alt="group205" />
</div>

<div style="display: flex; align-items: center;">
  <img translate="no"       src="http://localhost:8080/img/IV.png" style="margin-right:10px;" alt="iv"/>
  <p className="pageText">
    <b>Tumour and biomarker assessments</b>
  </p>
</div>
...
<div style="display:grid; grid-template-columns: 35% 65%; margin-top:2rem">
  <img translate="no"       src="http://localhost:8080/img/Index 1.png" alt="index1"/>
...
<div style="display: flex; align-items: center;">
  <img translate="no"       src="http://localhost:8080/img/Syringe.png" alt="syringe" style="margin-right:10px;" />
  <p className="pageText">
...
<div style="display: flex; align-items: center;">
  <img translate="no"       src="http://localhost:8080/img/ExtraSamples.png" alt="extrasampels" style="margin-right:10px;" />
  <p className="pageText">
