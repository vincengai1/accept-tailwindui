export const risksContentSection =
        ...
        <div class="font-san bg-astraGray-100 text-fontGray-100 p-8 flex flex-row rounded-xl mb-14">
          <div class="flex flex-row">
            <div  style="flex-basis:90%; margin-right:30px;">
              <Image loader={imageLoader}  width={500} height={500} unoptimized alt="risks" src="http://localhost:8080/img/Risks.png" style="height:80px; width:100%"/>
            </div>
        ...
        <div style="margin-bottom:10px; display: flex; align-items: center" class="font-serif text-md font-bold "  >
            <Image loader={imageLoader}  width={500} height={500} unoptimized alt="exclamation" src="http://localhost:8080/img/exclamation.png" style="margin-right: 10px"/>  Serious side effect  
        </div>
        ...
        <p className="pageText" style="margin-bottom: 2rem;">
         ...
         <Image loader={imageLoader}  width={500} height={500} unoptimized alt="graphic" src="http://localhost:8080/img/ILD-graphic.png" style="margin-bottom:2rem; width: 100%"/>

        <div style="margin-bottom:10px; display: flex; align-items: center" class="font-serif text-md font-bold "  >
          <Image loader={imageLoader}  width={500} height={500} unoptimized alt="syringe" src="http://localhost:8080/img/syringe.png" style="margin-right: 10px"/> Symptoms 
        </div>
        ...
        <div style="margin-bottom:10px; display: flex; align-items: center" class="font-serif text-md font-bold "  >
            <Image loader={imageLoader}  width={500} height={500} unoptimized alt="medicalHistory" src="http://localhost:8080/img/medicalHistory.png" style="margin-right: 10px"/> Medical history  
        </div>
        ...
        <div style="margin-bottom:10px; display: flex; align-items: center" class="font-serif text-md font-bold "  >
             <Image loader={imageLoader}  width={500} height={500} unoptimized alt="monitor" src="http://localhost:8080/img/Monitor.png" style="margin-right: 10px"/> Monitoring  
        </div>
        ...
        <div style="margin-bottom:10px; display: flex; align-items: center" class="font-serif text-md font-bold "  >
             <Image loader={imageLoader}  width={500} height={500} unoptimized alt="exclamationmark" src="http://localhost:8080/img/exclamation.png" style="margin-right: 10px"/> Serious reactions to look out for   
        </div>
        ...
        <div style="margin-bottom:10px; display: flex; align-items: center" class="font-serif text-md font-bold "  >
            <Image loader={imageLoader}  width={500} height={500} unoptimized alt="yellowalert" src="http://localhost:8080/img/YellowAlert.png" style="margin-right: 10px"/> Share with your doctor  
        </div>
        <p className="pageText" style="margin-bottom: 2rem">
          <ul>
       ...
       <Image loader={imageLoader}  width={500} height={500} unoptimized alt="yelloAlert" src="http://localhost:8080/img/YellowAlert.png" style="margin-right: 10px"/> Unexpected risks 
        </div>
        <p className="pageText" style="margin-bottom: 2rem">
        ...
        <Image loader={imageLoader}  width={500} height={500} unoptimized alt="frame176" src="http://localhost:8080/img/Frame176.png" style="margin-bottom:3rem"/>
        ...
        <p className="pageText" >
          <div style="display:flex; align-content:center; margin-bottom:10px; align-items: center;">
            <Image loader={imageLoader}  width={500} height={500} unoptimized alt="pregnant" src="http://localhost:8080/img/Pregnant.png" style="margin-right: 10px" /><b>Pregnancy, contraception and breast-feeding</b> <br/>
          </div>
        ...
        <p className="pageText" >
          <div style="display:flex; align-content:center; margin-bottom:10px;align-items: center;">
           <Image loader={imageLoader}  width={500} height={500} unoptimized alt="medicine" src="http://localhost:8080/img/Medicine.png" style="margin-right: 10px" /><b>Other medications/ vaccinations</b> <br/>
          </div>
           Because the effects of the study treatments on an unborn child or infant are not known, you
          (or your female partner if you are a man) must not get pregnant or breastfeed a child during
          the study. You must use effective birth control during the study and up to 7 months (if you
