...
<div className={classes.root}>
            ...
            <div class="basis-1/5">
              ...
              <div item xs container  spacing={3}>
                <div item xs>
                  ...
                  Treatment period lasts for <b>XXXX amount of time</b> and will involve on-site visits in Nashville, TN once every 1–3 weeks.<br/><br/>
        ...
        <div class="mb-14 font-serif text-md font-bold " id="Screening" style=marginBottom:'1rem'}}>
          Screening (0-28 days prior to starting the study treatment)        
        </div>

        <img src={Graphic} style=width: '100%', marginBottom: '3rem', cursor: 'pointer'}}/>

        <p className="pageText" style=marginBottom: '3rem'}}>
        ...
        <div class="mb-14 font-serif text-md font-bold " id="Treatment Period" style=marginBottom:'1rem'}}>
            Treatment period      
        </div>

        <img src={Graphic2} style=width: '100%', marginBottom: '3rem', cursor: 'pointer'}}/>
        ...
        <table className={classes.table}>
          <tr>
            <td style="padding-left: 10px; background-color: #244150; color:white; font-family: 'Noto Sans', sans-serif; font-weight: 800;">              <span>Module 0</span> <br/>
          ...
          <tr>
            <td style="padding-left: 10px; background-color: #244150; color:white; font-family: 'Noto Sans', sans-serif; font-weight: 800;">            Module 2</td>
            <td className={classes.td} >
          ...
          <tr>
                        <td style="padding-left: 10px; background-color: #244150; color:white; font-family: 'Noto Sans', sans-serif; font-weight: 800;">            Module 3</td>
            <td className={classes.td} >
          ...
          <tr>
                        <td style="padding-left: 10px; background-color: #244150; color:white; font-family: 'Noto Sans', sans-serif; font-weight: 800;">            Module 4</td>
            <td className={classes.td} >
        ...
        <div class="mb-14 font-serif text-md font-bold " id="Follow Up" style=marginBottom:'1rem'}}>
            Follow-up      
        </div>

        <img src={Graphic3} style=width: '100%', marginBottom: '3rem', cursor: 'pointer'}}/>
        ...
        <p className="pageText">
          ...
          expected, for example for scientific or safety reasons (<span style="color: #008764;">see “Section 9” for more details</span>).
        </p>
        ...
        <div class="mb-14 font-serif text-md font-bold " id="Required Tests & Procedures" style=marginBottom:'1rem'}}>
              ...
              <div item xs container  spacing={3}>
                <div item xs>
                  <p class="text-sm font-san">
                    On-site, you will regularly experience wellness checks, laboratory work, tumour and biomarker assessments, and your study treatment. At home, you’ll take
                    daily <span style="color:#008764;"> Pulse Oximetry readings.</span> <br/><br/>
                    These procedures will be minimally invasive. The most invasive/uncomfortable procedures will be<span style="color:#008764;"> tumour tissue collection and Magnetic
        ...
        <div class="mb-14 font-serif text-md font-bold " id="On Site" style=marginBottom:'1rem', font-size:'20px !important'}}>
            What you’ll experience regularly on-site
        </div>

        <div style="display: flex; align-items: center;">
          <img src={Wellness} style="marginRight:10px;"/>
          <p className="pageText" >
            <b>Wellness checks</b>
          </p>
        </div>
        ...
        <div  style="display:grid; grid-template-columns: 50% 50%">
          <div className="column1" style=padding:'10px'}}>
            ...
            <p className="pageText" style=font-size: '14px', marginLeft:'10px', margin-top: 0px'}}>
        ...
        <div style="display: flex; align-items: center;">
          <img src={Lab} style="marginRight:10px;"/>
          <p className="pageText" >
        ...
        <div style="display: flex; align-items: center;">
          <img src={XRay} style="marginRight:10px;"/>
          <p className="pageText" >
        ...
        <div style="display: flex; align-items: center;">
          <img src={IV} style="marginRight:10px;"/>
          <p className="pageText" >
            <b>Tumour and biomarker assessments</b>
          </p>
        </div>
        ...
        <div class="mb-14 font-serif text-md font-bold " id="At Home" style="margin-bottom:1rem; margin-top: 2rem; font-size:20px !important; align-ttems:center">
        ...
        <div style="display:grid; grid-template-columns: 35% 65%; margin-top:2rem">
          ...
          <div>
            <p className="pageText" style=fontWeight:'700', color:'#00A372'}}>
                At-Home Pulse Oximetry (SpO2)
            </p>
            <p className="pageText" >
                You will be asked to take daily Pulse Oximetry readings at home. The Pulse Oximetry reading measures the oxygen level of the blood and will help researchers understand  
                how the study medication may impact your blood oxygen level. The reading is easy and painless and will be taken using a device that will be provided to you.
            </p>
          </div>
        </div>
        ...
        <hr class="solid"  style="margin-bottom: 5rem; margin-top: 5rem;">

        <div class="mb-14 font-serif text-md font-bold " id="Optional Procedures" style=marginBottom:'1rem', font-size:'20px !important', margin-top:'2rem'}}>
        ...
        <div class="font-san bg-astraGray-100 text-fontGray-100 p-8 flex flex-row rounded-xl mb-14">
          <div container spacing={2} class="flex flex-row">
            <div  class="basis-1/2">
              <p>
                <img src={OptionalProcedures} style=height:'80px'}} />
              </p>
            </div>
            ...
            <div item xs={12} sm container>
              <div item xs container  spacing={3}>
                <div item xs>
                  <p   className="boxText">
                      You have the option to consent to the collection of extra tissue samples through <b>tumour biopsies</b>. The advantage is ___________. 
        ...
        <div style="display: flex; align-items: center;">
          <img src={Syringe} style="marginRight:10px;"/>
          <p className="pageText" >
        ...
        <div style="display: flex; align-items: center;">
          <img src={ExtraSamples} style="marginRight:10px;"/>
          <p className="pageText" >
        ...
        <div class="font-san bg-astraGray-100 text-fontGray-100 p-8 flex flex-row rounded-xl mb-14" style="background-color: #E6F7F2;" >
          <div container spacing={2} class="flex flex-row">
            <div  class="basis-1/2">
                <img src="https://brandmark.io/intro/info.png" class="h-80px mr-20" />
            </div>
            ...
            <div item xs={12} sm container>
              <div item xs container  spacing={3}>
                <div item xs>
                  <p className="boxText" style="font-size:'20px">
                    <b>Do you consent to the collection of extra tissue samples through tumour biopsies?</b> <br/>
                    <span style="font-size:16px !important">This is optional, and you can review your answers before you submit. You can also skip this question for now.</span>
                  </p>

                  <p className="pageText" style="font-size: 14px; margin-top: 0px; fontWeight:700">
                    I consent to an optional biopsy during the study treatment.
                  </p>

                  <div style="display:flex; margin-bottom:2rem">
                    <div style="display:flex; align-items:center; margin-right:30px">
                      <Checkbox sx={{ color: white; height: 30px; width: 30px"/> 
                      <div className="boxText">Yes</div> 
                    </div>

                    <div style="display:flex; align-item:center">
                      <Checkbox sx={{ color: white; height: 30px; width: 30px"/> 
                      <div className="boxText">No</div> 
                    </div>
                  </div>

                  <p className="pageText" style="font-size: '14px'; margin-top: 0px'; font-weight:'700">
  ...
  useEffect( () => {
    ...
    if (targetLanguage) {
      ...
      setLogisticsContent(translateSection('en', targetLanguage))
    }
  ...
  async function translateSection(sourceLanguage, targetLanguage) {
    ...
    // setLogisticsContent(response.json());
