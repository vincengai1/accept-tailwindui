...
export default function LearnMore({data}) {
  ...
  const introductionContentSection =
        `       
          ...
          <div class="font-serif text-md font-bold" style="margin-bottom:2rem;" id="Purpose of Consent">
          How to find out more after the study?
        </div>
        <div class=" bg-astraGray-100 text-fontGray-100 p-8 flex flex-row rounded-xl mb-8">
          <div  class="flex flex-row">
            <div  class="basis-1/2">
                <img src="http://localhost:8080/img/URLs.png" style="height:90px; margin-top: 1rem" />
            </div>
          ...
          <div class="font-serif text-md font-bold" style="margin-top:3rem;" id="Purpose of Consent">
          ...
          <div class="font-serif text-md font-bold" style="margin-bottom:2rem; margin-top:3rem;" id="Purpose of Consent">
        ...
        <div class=" bg-astraGray-100 text-fontGray-100 p-8 flex flex-row rounded-xl mb-14">
          <div  class="flex flex-row" style="padding-left:2rem;">
            <div  class="basis-1/2">
                <img src="http://localhost:8080/img/Contact.png" style="height:80px;" />
